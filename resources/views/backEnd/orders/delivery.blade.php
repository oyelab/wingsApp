	...
	<div class="row">
		<div class="col-xl-8">
			<div class="card">
				<div class="card-body">
					@if(session('response'))
						<div class="alert alert-{{ session('response')['type'] ?? 'info' }} alert-dismissible fade show"
							role="alert">
							...
							<table class="table align-middle mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<select class="form-select form-select-sm w-sm" id="recipient_city"
												name="recipient_city" required onchange="fetchZones()">
												<option value="">Select City</option>
											</select>
										</td>
										<td>
											<select class="form-select form-select-sm w-sm" id="recipient_zone"
												name="recipient_zone" required onchange="fetchAreas()">
												<option value="">Select Zone</option>
											</select>
										</td>
										<td>
											<select class="form-select form-select-sm w-sm" id="recipient_area"
												name="recipient_area">
									...
									<tr>
										...
										<td>
											<input class="form-control form-control-sm w-sm" type="text"
												name="special_instruction" id="special_instruction">
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										...
										<td colspan="3">
											<textarea class="form-control form-control-sm w-sm" name="item_description"
