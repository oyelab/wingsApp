		...
		<div class="row">
			<div class="col-lg-12">
				<div id="addproduct-accordion" class="custom-accordion">
					<form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data" id="product-form">
					@csrf
					@method('PUT')
						<div class="card">
								...
								<div class="p-4 border-top">
									<div class="row d-flex">
										<div class="col-lg-6 mb-3">
											...
											<input id="productname" name="name" placeholder="Enter Product Name" type="text" class="form-control" value="{{ $category->name }}">
										</div>
									...
									<div class="form-group">
										<div id="catImgPreview">
											@if($category->cover) <!-- Display existing image if available -->
												<img src="{{ asset('images/categories/' . $category->cover) }}" alt="Current Cover" style="max-width: 50%; height: auto; margin-top: 10px;">
											@endif
										</div>
									</div>
								</div>
						...
						<div class="text-center mx-auto col-lg-12 sticky-container mb-4">
							<div class="d-grid gap-2">
								<button type="submit" class="btn btn-primary btn-lg">
									<i class="bx bx-file me-1"></i> Update Category
								</button>
