    ...
    <div id="details-container">
        ...
        @foreach ($showcase->details as $index => $detail)
            <div class="detail-item mb-3">
                ...
                <label for="details[{{ $index }}][image]" class="form-label">Image</label>
        ...
        <div class="detail-item mb-3">
            ...
            <label for="details[new][image]" class="form-label">Image</label>
            <input type="file" name="details[new][image]" class="form-control">
            ...
            if (e.target.classList.contains('add-detail')) {
                ...
                const newDetailHtml = `
                    <div class="detail-item mb-3">
                        ...
                        <label for="details[${detailCount}][image]" class="form-label">Image</label>
                        <input type="file" name="details[${detailCount}][image]" class="form-control">
