			...
			@foreach($products as $product)
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden wings-light">
						<!-- Product Image -->
						<a href="{{ route('sections.products.details', ['section' => $section, 'slug' => $product->slug]) }}" class="href">
						{{ $product->name }}
					</a>
						...
						<div class="card-footer bg-transparent border-0 text-center">
							<a href="{{ route('sections.products.details', ['section' => $section, 'slug' => $product->slug]) }}" class="btn btn-outline-primary w-100 py-2 fs-6 rounded-2">
