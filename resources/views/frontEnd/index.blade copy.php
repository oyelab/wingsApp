...
<section class="latest-arrivals-area section-padding">
    <div class="container">
        <div class="row">
            <div class="d-flex align-items-center justify-content-between mb-30">
                <div class="section-title">
                    <h3>{{ $latestTitle }}</h3> <!-- Adjusted title -->
                </div>
                <div class="navigation-items d-flex align-items-center">
                    <h3><a href="#">Shop</a></h3> <!-- Update this route if necessary -->
        ...
        <div class="swiper latest-arrival">
            <div class="swiper-wrapper">
                @foreach ($latest as $product) <!-- Adjusted to use latestProducts -->
                <div class="swiper-slide">
...
<section class="latest-arrivals-area section-buttom-padding">
	<div class="container">
		<div class="row">
			...
			>
				<div class="section-title">
					<h2>{{ $titles['topPicksTitle'] }}</h2>
				</div>
				<div class="navigation-items d-flex align-items-center">
				<h3><a href="{{ route('shop.pages', ['section' => $topPicksSection->slug]) }}">
            Shop
        </a></h3>
				<div
