...
return [
    ...
    */
	...
	'public_path' => public_path(),  // This is the default public path, pointing to your project's public directory
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        'font_dir' => public_path('build/fonts/Manrope/static/'), // advised by dompdf (https://github.com/dompdf/dompdf/pull/782)
        ...
        'isRemoteEnabled' => false, // Allow loading external resources like images and fonts
    ],
